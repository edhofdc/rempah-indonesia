          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-green-50 border-b border-green-200">
                <th className="text-left px-4 py-3 font-semibold text-green-800">Name</th>
                <th className="text-left px-4 py-3 font-semibold text-green-800">Category</th>
                <th className="text-right px-4 py-3 font-semibold text-green-800">Price</th>
                <th className="text-right px-4 py-3 font-semibold text-green-800">Stock</th>
                <th className="text-center px-4 py-3 font-semibold text-green-800">Status</th>
                <th className="text-center px-4 py-3 font-semibold text-green-800">Actions</th>
              </tr>
            </thead>
                ...
                products.map((product) => (
                  <tr key={product.id} className="hover:bg-green-50/50 transition-colors">
                    <td className="px-4 py-3">
                      ...
                      {product.sku && <p className="text-[10px] text-green-400">SKU: {product.sku}</p>}
                    </td>
                    <td className="px-4 py-3 text-green-600">{product.category.name}</td>
                    <td className="px-4 py-3 text-right font-medium text-brown-700">{formatPrice(product.price)}</td>
                    <td className="px-4 py-3 text-right">
                      <span className={product.stock <= 10 ? 'text-red-600 font-medium' : 'text-green-700'}>
                        {product.stock}
                      </span>
                    </td>
                    <td className="px-4 py-3 text-center">
                      <span className={`inline-block px-2 py-0.5 rounded text-xs font-medium border ${
                        statusStyles[product.status] || 'bg-gray-100 text-gray-700 border-gray-300'
                      }`}>
                        {product.status}
                      </span>
                    </td>
          ...
          <div className="relative bg-white rounded-xl border border-green-200 shadow-xl w-full max-w-lg max-h-[90vh] overflow-y-auto animate-scale-in">
            ...
            <div className="p-5 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-green-700 mb-1">Weight</label>
                  <input
                    type="text"
                    value={form.weight}
                ...
                <div>
                  <label className="block text-sm font-medium text-green-700 mb-1">Origin</label>
                  <input
                    type="text"
                    value={form.origin}
                ...
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-green-700 mb-1">Benefits</label>
                  <textarea
                    value={form.benefits}
